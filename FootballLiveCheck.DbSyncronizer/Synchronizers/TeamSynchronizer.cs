...
////    //        var entitiesToInsert = updatedTeams.Where(de => !unupdatedTeams.Any(ae => ae.ApiId == de.Id));
...
////    //                    var entitiesToDelete = unupdatedTeams.Where(ae => !updatedTeams.Any(de => ae.ApiId == de.Id));
////    //                    foreach (var entity in entitiesToDelete)
////    //                        teamHelper.Delete(entity);
////    //                    //delete entities that don't apear in Api

////    //                    var entitiesToUpdate =
////    //                        updatedTeams.Where(ae => unupdatedTeams.Any(de => de.ApiId == ae.Id && !de.Equals(ae)));
////    //                    foreach (var entity in entitiesToUpdate)
////    //                    {
////    //                        var team = teamHelper.GetByApiId(entity.Id);
